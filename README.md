...
# LiTS (gan) — Task003
Invoke-WebRequest -Uri "https://zenodo.org/records/4003545/files/Task003_Liver.zip?download=1" -OutFile "C:\Users\T.Hung\Task003_Liver.zip"
nnUNet_install_pretrained_model_from_zip "C:\Users\T.Hung\Task003_Liver.zip"
```
